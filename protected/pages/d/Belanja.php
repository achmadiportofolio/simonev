...
class Belanja extends MainPageBelanja {
	...
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageBelanja'])||$_SESSION['currentPageBelanja']['page_name']!='d.Belanja') {
                $_SESSION['currentPageBelanja']=array('page_name'=>'d.Belanja','page_num'=>0,'dataKegiatan'=>array());												
            }
    ...
    public function detailsProgram ($sender,$param) {
        ...
        if (!isset($_SESSION['currentPageKegiatan'])||$_SESSION['currentPageKegiatan']['page_name']!='d.belanja.Kegiatan') {
            $_SESSION['currentPageKegiatan']=array('page_name'=>'d.belanja.Kegiatan','page_num'=>0,'idprogram'=>'none','search'=>false,'userid'=>'none');												
        }
