<?php
prado::using ('Application.pages.d.pendapatan.MainPagePendapatan');
class Pendapatan extends MainPagePendapatan {
	...
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPagePendapatan'])||$_SESSION['currentPagePendapatan']['page_name']!='d.Pendapatan') {
                $_SESSION['currentPagePendapatan']=array('page_name'=>'d.Pendapatan','page_num'=>0,'dataKegiatan'=>array());												
            }
