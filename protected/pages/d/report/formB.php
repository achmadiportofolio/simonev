...
class formB extends MainPageReports {			
	public function onLoad ($param) {		
        ...
        if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPageFormB'])||$_SESSION['currentPageFormB']['page_name']!='d.report.formB') {
                $_SESSION['currentPageFormB']=array('page_name'=>'d.report.formB','page_num'=>0,'listProgram'=>null);												
            }
