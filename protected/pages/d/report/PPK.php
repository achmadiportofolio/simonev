	...
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            ...
            if (isset($_SESSION['currentPageReportPPK']['datakegiatan']['nip_ppk'])) {               
                ...
                if (!isset($_SESSION['currentPageReportPPK'])||$_SESSION['currentPageReportPPK']['page_name']!='d.report.ReportPPK') {
                    $_SESSION['currentPageReportPPK']=array('page_name'=>'d.report.ReportPPK','page_num'=>0,'datakegiatan'=>array());												
                }            
