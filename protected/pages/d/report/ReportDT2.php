...
class ReportDT2 extends MainPageReports {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            ...
            if (isset($_SESSION['currentPageReportDT2']['datakegiatan']['iddt2'])) {
                ...
                if (!isset($_SESSION['currentPageReportDT2'])||$_SESSION['currentPageReportDT2']['page_name']!='d.report.ReportDT2') {
                    $_SESSION['currentPageReportDT2']=array('page_name'=>'d.report.ReportDT2','page_num'=>0,'datakegiatan'=>array());												
                }                            
    ...
    public function viewRecord($sender,$param) {
        ...
        $this->redirect('d.report.ReportDT2');
    }    
