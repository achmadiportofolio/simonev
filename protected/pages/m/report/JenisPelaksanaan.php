...
class JenisPelaksanaan extends MainPageReports {	
	...
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallback) {
            if (isset($this->session['currentPageReportJP']['dataKegiatan']['kode'])) {                
                ...
                if (!isset($_SESSION['currentPageReportJP'])||$_SESSION['currentPageReportJP']['page_name']!='m.report.JenisPelaksanaan') {
                    $_SESSION['currentPageReportJP']=array('page_name'=>'m.report.JenisPelaksanaan','page_num'=>0,'dataKegiatan'=>array());												
                }            
                $this->populateData ();
	...
	public function viewRecord ($sender,$param) {
        ...
        $this->redirect('m.report.JenisPelaksanaan');        
	}
