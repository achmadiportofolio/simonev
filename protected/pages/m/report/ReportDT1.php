...
class ReportDT1 extends MainPageReports {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {            
            ...
            if (isset($_SESSION['currentPageReportDT1']['datakegiatan']['iddt1'])) {
                ...
                if (!isset($_SESSION['currentPageReportDT1'])||$_SESSION['currentPageReportDT1']['page_name']!='m.report.ReportDT1') {
                    $_SESSION['currentPageReportDT1']=array('page_name'=>'m.report.ReportDT1','page_num'=>0,'datakegiatan'=>array());												
                }              
    ...
    public function viewRecord($sender,$param) {
        ...
        $this->redirect('m.report.ReportDT1');
    }    
