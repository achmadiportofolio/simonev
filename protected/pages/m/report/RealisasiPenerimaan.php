...
class RealisasiPenerimaan extends MainPageReports {	    
	public function onLoad ($param) {		
        ...
        if (!$this->IsPostBack&&!$this->IsCallBack) {            
            if (!isset($_SESSION['currentPageRealisasiPenerimaan'])||$_SESSION['currentPageRealisasiPenerimaan']['page_name']!='m.report.RealisasiPenerimaan') {
                $_SESSION['currentPageRealisasiPenerimaan']=array('page_name'=>'m.report.RealisasiPenerimaan','page_num'=>0,'dataKegiatan'=>array(),'idprogram'=>'none','search'=>false,'userid'=>'none');												
            }                
                                                ...
                                                foreach ($tingkat_5 as $k5=>$v5) {
                                                    if (ereg ($k4,$k5)) {                                                       
                                                        ...
                                                        if ($data_rek5[1]) {
                                                            ...
                                                            $url=$this->Service->constructUrl('m.report.RealisasiPenerimaanDetails',array('id'=>$idtarget));
