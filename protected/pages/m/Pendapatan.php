<?php
prado::using ('Application.pages.m.pendapatan.MainPagePendapatan');
class Pendapatan extends MainPagePendapatan {
	...
	public function onLoad($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPagePendapatan'])||$_SESSION['currentPagePendapatan']['page_name']!='m.Pendapatan') {
                $_SESSION['currentPagePendapatan']=array('page_name'=>'m.Pendapatan','page_num'=>0,'dataKegiatan'=>array());												
            }
