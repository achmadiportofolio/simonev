...
class Profiles extends MainPage {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPageProfiles'])||$_SESSION['currentPageProfiles']['page_name']!='m.Profiles') {
                $_SESSION['currentPageProfiles']=array('page_name'=>'m.Profiles','page_num'=>0,'roles'=>'m','search'=>false);												
			}                             
			$this->populateData ();			            
		}
	}    
