...
class PelaksanaanAnggaran extends MainPageReports {			
	public function onLoad ($param) {		
        ...
        if (!$this->IsPostBack&&!$this->IsCallBack) {
            if (!isset($_SESSION['currentPagePelaksanaanAnggaran'])||$_SESSION['currentPagePelaksanaanAnggaran']['page_name']!='t.report.PelaksanaanAnggaran') {
                $_SESSION['currentPagePelaksanaanAnggaran']=array('page_name'=>'t.report.PelaksanaanAnggaran','page_num'=>0,'listProgram'=>null);												
            }
