...
class KuasaPengguna extends MainPageReports {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            ...
            if (isset($_SESSION['currentPageReportKuasaPengguna']['datakegiatan']['nip_kuasa_pengguna'])) {               
                ...
                if (!isset($_SESSION['currentPageReportKuasaPengguna'])||$_SESSION['currentPageReportKuasaPengguna']['page_name']!='t.report.ReportKuasaPengguna') {
                    $_SESSION['currentPageReportKuasaPengguna']=array('page_name'=>'t.report.ReportKuasaPengguna','page_num'=>0,'datakegiatan'=>array());												
                }            
    ...
    public function viewRecord($sender,$param) {
        ...
        $this->redirect('t.report.KuasaPengguna');
    }    
