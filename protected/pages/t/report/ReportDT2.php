...
class ReportDT2 extends MainPageReports {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            ...
            if (isset($_SESSION['currentPageReportDT2']['datakegiatan']['iddt2'])) {
                ...
                if (!isset($_SESSION['currentPageReportDT2'])||$_SESSION['currentPageReportDT2']['page_name']!='t.report.ReportDT1') {
                    $_SESSION['currentPageReportDT2']=array('page_name'=>'t.report.ReportDT1','page_num'=>0,'datakegiatan'=>array());												
                }                            
    ...
    public function viewRecord($sender,$param) {
        ...
        $this->redirect('t.report.ReportDT2');
    }    
