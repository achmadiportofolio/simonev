...
class Profiles extends MainPage {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPageProfiles'])||$_SESSION['currentPageProfiles']['page_name']!='t.Profiles') {
                $_SESSION['currentPageProfiles']=array('page_name'=>'t.Profiles','page_num'=>0,'roles'=>'t','search'=>false);												
			}                             
			$this->populateData ();			            
		}
	}    
