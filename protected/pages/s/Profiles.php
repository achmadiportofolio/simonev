...
class Profiles extends MainPage {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {	
            if (!isset($_SESSION['currentPageProfiles'])||$_SESSION['currentPageProfiles']['page_name']!='s.Profiles') {
                $_SESSION['currentPageProfiles']=array('page_name'=>'s.Profiles','page_num'=>0,'roles'=>'s','search'=>false);												
			}                             
			$this->populateData ();			            
		}
	}    
