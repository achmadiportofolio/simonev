...
class PenggunaAnggaran extends MainPageReports {
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            ...
            if (isset($_SESSION['currentPageReportPenggunaAnggaran']['datakegiatan']['nip_pengguna_anggaran'])) {               
                ...
                if (!isset($_SESSION['currentPageReportPenggunaAnggaran'])||$_SESSION['currentPageReportPenggunaAnggaran']['page_name']!='s.report.ReportPenggunaAnggaran') {
                    $_SESSION['currentPageReportPenggunaAnggaran']=array('page_name'=>'s.report.ReportPenggunaAnggaran','page_num'=>0,'datakegiatan'=>array());												
                }            
    ...
    public function viewRecord($sender,$param) {
        ...
        $this->redirect('s.report.PenggunaAnggaran');
    }    
