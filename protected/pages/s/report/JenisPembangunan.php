...
class JenisPembangunan extends MainPageReports {	
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallback) {
            if (isset($this->session['currentPageReportJenisPembangunan']['dataKegiatan']['idjenis_pembangunan'])) {                
                ...
                if (!isset($_SESSION['currentPageReportJenisPembangunan'])||$_SESSION['currentPageReportJenisPembangunan']['page_name']!='s.report.JenisPembangunan') {
                    $_SESSION['currentPageReportJenisPembangunan']=array('page_name'=>'s.report.JenisPembangunan','page_num'=>0,'dataKegiatan'=>array());												
                }            
                $this->populateData ();
	...
	public function viewRecord ($sender,$param) {
        ...
        $this->redirect('s.report.JenisPembangunan');        
	}
