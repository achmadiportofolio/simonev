	...
	public function onLoad ($param) {		
		...
		if (!$this->IsPostBack&&!$this->IsCallBack) {
            ...
            if (isset($_SESSION['currentPageReportPPTK']['datakegiatan']['nip_pptk'])) {               
                ...
                if (!isset($_SESSION['currentPageReportPPTK'])||$_SESSION['currentPageReportPPTK']['page_name']!='s.report.ReportPPTK') {
                    $_SESSION['currentPageReportPPTK']=array('page_name'=>'s.report.ReportPPTK','page_num'=>0,'datakegiatan'=>array());												
                }            
